...
IfThenElseStatement:
IF LEFT_PARANTHESIS Expression RIGHT_PARANTHESIS StatementNoShortIf IfThenElseStatementEnd
;

IfThenElseStatementEnd:
ELSE Statement		
;

IfThenElseStatementNoShortIf:
IF LEFT_PARANTHESIS Expression RIGHT_PARANTHESIS StatementNoShortIf IfThenElseStatementNoShortIfEnd
;

IfThenElseStatementNoShortIfEnd:
