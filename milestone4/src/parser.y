...
| PrintStatement                                {if(!first_parse){$$->i_number=$1->i_number;}}
;
...
PrintStatement:
PRINT LEFT_PARANTHESIS InclusiveOrExpression RIGHT_PARANTHESIS SEMI_COLON   {if(!first_parse){string k = $3->temp_var; $$->i_number = $3->i_number; emitt("string","print("+k+")","","",-1);}}
